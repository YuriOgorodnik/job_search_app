...
class Vacancy:
    """
    Класс для отображения информации о вакансии
    """
    ...
    def __eq__(self, other: 'Vacancy') -> bool:
        """
        Проверяет, равны ли две вакансии по уровню заработной платы.

        :param other: Другая вакансия для сравнения.
        :return: Если заработные платы в вакансиях равны, то True, иначе - False.
        """
    ...
    def __lt__(self, other: 'Vacancy') -> bool:
        ...
        :param other: Другая вакансия для сравнения.
        :return: Если текущая вакансия имеет меньшую зарплату, то True, иначе - False.
        """
        return self.salary < other.salary
    ...
    def validate_salary(self) -> bool:
        ...
        :return: Если зарплата валидна, то True, иначе - False.
        """
    ...
    def validate_data(self) -> bool:
        ...
        :return: Если все данные по вакансии валидны, то True, иначе - False.
        """
